...
class Controller(object):
    ...
    @staticmethod
    def RemoveExternalAsset(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
